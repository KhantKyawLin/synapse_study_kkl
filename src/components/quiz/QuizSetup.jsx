...
export default function QuizSetup({
  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between p-3.5 bg-[#161b22]/90 border border-slate-800 rounded-2xl backdrop-blur-xl">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-cyanPrimary/20 border border-cyanPrimary/40 flex items-center justify-center text-cyanPrimary">
            <Award className="w-4 h-4" />
          </div>
          <div>
            <span className="text-xs font-bold text-white block leading-tight">Exam Prep Assessments</span>
            <span className="text-[10px] text-slate-400">Verified medical certification exams</span>
          </div>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-[#0d1117] border border-cyanPrimary/40 text-cyanGlow hover:bg-cyanPrimary hover:text-white transition-all shadow-md shadow-cyanPrimary/10"
        >
      ...
      <div className="bg-[#161b22]/90 border border-slate-800 rounded-2xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl animate-fadeIn">
