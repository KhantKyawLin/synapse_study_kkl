...
export default function QuizHistoryModal({ isOpen, onClose, history = [], stats = {} }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div 
        className="w-full max-w-4xl max-h-[90vh] bg-[#161b22] border border-cyanPrimary/40 rounded-2xl shadow-2xl shadow-cyanPrimary/10 flex flex-col overflow-hidden text-slate-200"
      ...
      >
        ...
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-[#0d1117]/60">
          ...
          {selectedAttempt ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                {history.length === 0 ? (
                  <div className="text-center py-12 bg-[#0d1117]/60 border border-slate-800/80 rounded-2xl p-6">
                  ...
                  <div className="flex flex-col gap-2.5">
                    {history.map((item, index) => {
                      ...
                      return (
                        <div
                          key={item.id || index}
                          className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3.5 sm:p-4 bg-[#0d1117] border border-slate-800/90 hover:border-cyanPrimary/40 rounded-xl transition-all"
                        >
