...
export default function FilterBar({
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-2xl mx-auto mb-6">
      ...
      <div className="flex items-center justify-between p-1 bg-slate-200/80 dark:bg-[#13171f] border border-slate-300 dark:border-slate-800 rounded-xl shadow-inner">
        <button
